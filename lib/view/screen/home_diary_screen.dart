...
class HomeDiaryScreen extends GetView<DiaryController> {
  const HomeDiaryScreen({Key? key, required this.user, required this.addBtnVisible, required this.me}) : super(key: key);
  final Friend user;
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<RxList<Diary>>(
      future: controller.getFriendDiary(user.uid),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (me) {
            diaryList.value = controller.diaryList;
          } else {
            diaryList.value = snapshot.data!;
          }
                    ...
                    () => TableCalendar(
                      ...
                      calendarBuilders: CalendarBuilders(
                        ...
                        markerBuilder: (context, date, events) {
                          bool hasMarker = diaryList.any((diary) {
